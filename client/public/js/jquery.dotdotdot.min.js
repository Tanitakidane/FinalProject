...
(function($, undef) {
  ...
  $.fn.dotdotdot = function(o) {
      ...
      $dot.bind(
        ...
        function(e, c) {
          ...
          if (typeof c != 'undefined') {
            if (typeof c === 'string' || ('nodeType' in c && c.nodeType ===
                1)) {
    ...
    if (!(opts.lastCharacter.remove instanceof Array)) {
      opts.lastCharacter.remove = $.fn.dotdotdot.defaultArrays.lastCharacter
        .remove;
    }
    if (!(opts.lastCharacter.noEllipsis instanceof Array)) {
      opts.lastCharacter.noEllipsis = $.fn.dotdotdot.defaultArrays.lastCharacter
        .noEllipsis;
    }
  ...
  function ellipsisElement($e, $d, $i, o, after) {
    ...
    if (o.maxLength) {
      ...
      if (position != -1 && !(textArr.length === 1 && textArr[0].length === 0)) {
        ...
        var afterLength = (after && after.closest($w).length) ? after.length :
          0;
  ...
  function test($i, o) {
    return ($i.innerHeight() > o.maxHeight || (o.maxLength && $i.text().trim()
      .length > o.maxLength));
  }
