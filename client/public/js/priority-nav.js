(function(root, factory) {
  ...
  var listeners = function(_this, settings) {
    ...
    // Toggle dropdown
    _this.querySelector(navDropdownToggle).addEventListener("click",
      function() {
        ...
        if (-1 !== _this.className.indexOf("is-open")) {
          _this.querySelector(navDropdown).setAttribute("aria-hidden",
            "false");
        } else {
          _this.querySelector(navDropdown).setAttribute("aria-hidden",
            "true");
    ...
    document.onkeydown = function(evt) {
      ...
      if (evt.keyCode === 27) {
        ...
        document.querySelector(navDropdownToggle).classList.remove(
          "is-open");
